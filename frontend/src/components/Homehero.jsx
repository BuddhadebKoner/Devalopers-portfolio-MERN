         ...
         >
            <div
               className={`home_container_heading_content flex flex-row items-center justify-center gap-8 ${
                  themeMode === 'dark' ? 'text-primaryDarkText' : 'text-primaryLightText'
               }`}
            >
               ...
               <div className="typewriter flex items-center justify-start">
                  <h1
                     className={`text-5xl font-black font-mono ${
                        themeMode === 'dark' ? 'text-primaryDarkFocus' : 'text-primaryLightFocus'
                     } overflow-hidden`}
                  >
                     {name}
                  </h1>
            ...
            <p
               className={`home_hero_container_bio text-2xl ${
                  themeMode === 'dark' ? 'text-secoundryDarkText' : 'text-secoundryLightText'
               }`}
            >
               {bio}
            </p>
            <div className="home_hero_container_btn mt-14">
               <a
                  ...
                  className={`inline-block rounded-lg border-2 ${
                     themeMode === 'dark' ? 'border-secoundryDarkText' : 'border-secoundryLightText text-primaryDarkBG'
               ...
               <div
                  className={`w-full h-1.5 mt-5 ${
                     themeMode === 'dark' ? 'bg-primaryDarkFocus' : 'bg-primaryLightFocus'
                  }`}
               ></div>
            </div>
         </section>
